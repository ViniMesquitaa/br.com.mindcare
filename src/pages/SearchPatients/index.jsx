...
export function SearchPatients() {
  ...
  const ROWS = useMemo(() => {
    return (
      mock?.map((pacient) => ({
        ...
        details: (
          <UserRoundSearch
            className="search-pacient-details"
  ...
  return (
    <div className="search_professionals_container">
      <span className="search-pacient-welcome_message">{`Olá, Seja bem-vindo(a), ${loggedUser?.nome}!`}</span>
      <div className="search-pacient-table_container">
