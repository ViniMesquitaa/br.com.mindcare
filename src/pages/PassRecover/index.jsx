  ...
  return (
    <div className="container">
      ...
      <div className="novasenha">
        ...
        <form>
          <label htmlFor="nova-senha" className="label1">
            Nova senha <span className="spanred">*</span>
          </label>
          <input
            type="password"
            id="nova-senha"
          ...
          <label htmlFor="confirmar-senha" className="label1">
            Confirmação de senha <span className="spanred">*</span>
          </label>
          <input
            type="password"
            id="confirmar-senha"
