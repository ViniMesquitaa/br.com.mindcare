  ...
  return (
    <div className="container">
      ...
      <h1 className="titulo">Recuperar Senha</h1>
        ...
        <form>
            <label htmlFor="email">Email <span className="spanred">*</span></label>
      ...
      <h1 className="titulo">Cadastrar Nova Senha</h1>
        <form>
        <label htmlFor="nova-senha">Nova senha <span className="spanred">*</span></label>
            <input type="password" id="nova-senha" name="nova-senha" required/>

            <label htmlFor="confirmar-senha">Confirmação de senha <span className="spanred">*</span></label>
