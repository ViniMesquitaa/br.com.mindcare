...
const Home = () => {
  ...
  return (
    <div>
      ...
      >
        <div style={{ width: "50%" }}>
          <Table columns={COLUMNS_PROFISSIONAIS} rows={ROWS_PROFISSIONAIS} />
        </div>
        <div style={{ width: "50%" }}>
          <Table columns={COLUMNS_PACIENTE} rows={ROWS_PACIENTE} />
        </div>
      </div>
    </div>
  );
